document.addEventListener('DOMContentLoaded', () => {
    ...
    const gameData = [
        ...
        { type: 'event', text: 'Секретный портал! Переместитесь на клетку 25.' , moveTo: 25 },
        ...
        { type: 'event', text: 'Подарок от феи! Соперник теряет 5 очков.' },
        ...
        { type: 'event', text: 'Время перемен! Команды меняются очками.' },
        ...
        { type: 'event', text: 'Щедрость! Поделитесь 10 очками с соперником.' },
